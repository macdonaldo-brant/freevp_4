...
def market_order(symbol, volume, order_type, deviation):
    ...
    return {"ticket": order_result.get("ticket"), "price": order_result.get("price")}  # Return a dictionary
    ...
    while True:
        ...
        if direction == 'buy':
            ...
            if not mt5.positions_total():
                ...
                sell_positions = mt5.positions_get(symbol=SYMBOL, action=mt5.TRADE_ACTION_SELL)
            ...
            if not mt5.positions_total():
                ...
                buy_positions = mt5.positions_get(symbol=SYMBOL, action=mt5.TRADE_ACTION_BUY)
